...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/assets/imgs/theme/favicon.ico') }}">
...
<body>
                        ...
                        <ul>
                                <li>
                                    ...
                                    <ul class="language-dropdown">
                                        <li><a href="#"><img src="{{ asset('public/assets/imgs/theme/flag-fr.png') }}" alt="">Français</a></li>
                                        <li><a href="#"><img src="{{ asset('public/assets/imgs/theme/flag-dt.png') }}" alt="">Deutsch</a></li>
                                        <li><a href="#"><img src="{{ asset('public/assets/imgs/theme/flag-ru.png') }}" alt="">Pусский</a></li>
                                    </ul>
                                </li>                                
                            </ul>
                        </div>
                            ...
                            <div class="header-action-2">
                                <div class="header-action-icon-2">
                                    <a href="shop-wishlist.php">
                                        <img class="svgInject" alt="Surfside Media" src="{{ asset('public/assets/imgs/theme/icons/icon-heart.svg') }}">
                                            ...
                                            <ul class="mega-menu d-lg-flex">
                                                ...
                                                <li class="mega-menu-col col-lg-5">
                                                    <div class="header-banner2">
                                                        <img src="{{ asset('public/assets/imgs/banner/menu-banner-2.jpg') }}" alt="menu_banner1">
    ...
    <!-- Template  JS -->
    <script src="{{ asset('public/assets/js/main.js?v=3.3') }}"></script>
    <script src="{{ asset('public/assets/js/shop.js?v=3.3') }}"></script>
    @livewireScripts
</body>
