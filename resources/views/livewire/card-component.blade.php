                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="image product-thumbnail"><img src="{{ asset('public/assets/imgs/shop/product-1-2.jpg') }}" alt="#"></td>
                                    ...
                                    <tr>
                                        <td class="image"><img src="{{ asset('public/assets/imgs/shop/product-11-2.jpg') }}" alt="#"></td>
                                    ...
                                    <tr>
                                        <td class="image"><img src="{{ asset('public/assets/imgs/shop/product-6-1.jpg') }}" alt="#"></td>
                                        <td class="product-des">
